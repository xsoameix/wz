...
#define offsetof(a, b) (size_t) ((char *) (&(a)->b) - (char *) (a))
  ...
  printf("offset n16_e.parent    %2zu\n", offsetof(&n, n16_e.parent));
  printf("offset n16_e.root      %2zu\n", offsetof(&n, n16_e.root));
  printf("offset n16_e.type      %2zu\n", offsetof(&n, n16_e.type));
  printf("offset n16_e.name_len  %2zu\n", offsetof(&n, n16_e.name_len));
  printf("offset n16_e.name      %2zu\n", offsetof(&n, n16_e.name));
  printf("sizeof n16_e.name      %2zu\n", sizeof(n.n16_e.name));
  printf("offset n16_e.val       %2zu\n", offsetof(&n, n16_e.val));
  printf("\n");
  printf("sizeof n16             %2zu\n", sizeof(n.n16));
  printf("offset n16.parent      %2zu\n", offsetof(&n, n16.parent));
  printf("offset n16.root        %2zu\n", offsetof(&n, n16.root));
  printf("offset n16.type        %2zu\n", offsetof(&n, n16.type));
  printf("offset n16.name_len    %2zu\n", offsetof(&n, n16.name_len));
  printf("offset n16.name        %2zu\n", offsetof(&n, n16.name));
  printf("offset n16.val         %2zu\n", offsetof(&n, n16.val));
  printf("\n");
  printf("sizeof n32_e           %2zu\n", sizeof(n.n32_e));
  printf("offset n32_e.parent    %2zu\n", offsetof(&n, n32_e.parent));
  printf("offset n32_e.root      %2zu\n", offsetof(&n, n32_e.root));
  printf("offset n32_e.type      %2zu\n", offsetof(&n, n32_e.type));
  printf("offset n32_e.name_len  %2zu\n", offsetof(&n, n32_e.name_len));
  printf("offset n32_e.name      %2zu\n", offsetof(&n, n32_e.name));
  printf("sizeof n32_e.name      %2zu\n", sizeof(n.n32_e.name));
  printf("offset n32_e.val       %2zu\n", offsetof(&n, n32_e.val));
  printf("\n");
  printf("sizeof n32             %2zu\n", sizeof(n.n32));
  printf("offset n32.parent      %2zu\n", offsetof(&n, n32.parent));
  printf("offset n32.root        %2zu\n", offsetof(&n, n32.root));
  printf("offset n32.type        %2zu\n", offsetof(&n, n32.type));
  printf("offset n32.name_len    %2zu\n", offsetof(&n, n32.name_len));
  printf("offset n32.name        %2zu\n", offsetof(&n, n32.name));
  printf("offset n32.val         %2zu\n", offsetof(&n, n32.val));
  printf("\n");
  printf("sizeof n64_e           %2zu\n", sizeof(n.n64_e));
  printf("offset n64_e.parent    %2zu\n", offsetof(&n, n64_e.parent));
  printf("offset n64_e.root      %2zu\n", offsetof(&n, n64_e.root));
  printf("offset n64_e.type      %2zu\n", offsetof(&n, n64_e.type));
  printf("offset n64_e.name_len  %2zu\n", offsetof(&n, n64_e.name_len));
  printf("offset n64_e.name      %2zu\n", offsetof(&n, n64_e.name));
  printf("sizeof n64_e.name      %2zu\n", sizeof(n.n64_e.name));
  printf("offset n64_e.val       %2zu\n", offsetof(&n, n64_e.val));
  printf("\n");
  printf("sizeof n64             %2zu\n", sizeof(n.n64));
  printf("offset n64.parent      %2zu\n", offsetof(&n, n64.parent));
  printf("offset n64.root        %2zu\n", offsetof(&n, n64.root));
  printf("offset n64.type        %2zu\n", offsetof(&n, n64.type));
  printf("offset n64.name_len    %2zu\n", offsetof(&n, n64.name_len));
  printf("offset n64.name        %2zu\n", offsetof(&n, n64.name));
  printf("offset n64.val         %2zu\n", offsetof(&n, n64.val));
  printf("\n");
  printf("sizeof nv_e            %2zu\n", sizeof(n.nv_e));
  printf("offset nv_e.parent     %2zu\n", offsetof(&n, nv_e.parent));
  printf("offset nv_e.root       %2zu\n", offsetof(&n, nv_e.root));
  printf("offset nv_e.type       %2zu\n", offsetof(&n, nv_e.type));
  printf("offset nv_e.name_len   %2zu\n", offsetof(&n, nv_e.name_len));
  printf("offset nv_e.name       %2zu\n", offsetof(&n, nv_e.name));
  printf("sizeof nv_e.name       %2zu\n", sizeof(n.nv_e.name));
  printf("offset nv_e.val        %2zu\n", offsetof(&n, nv_e.val));
  printf("\n");
  printf("sizeof nv              %2zu\n", sizeof(n.nv));
  printf("offset nv.parent       %2zu\n", offsetof(&n, nv.parent));
  printf("offset nv.root         %2zu\n", offsetof(&n, nv.root));
  printf("offset nv.type         %2zu\n", offsetof(&n, nv.type));
  printf("offset nv.name_len     %2zu\n", offsetof(&n, nv.name_len));
  printf("offset nv.name         %2zu\n", offsetof(&n, nv.name));
  printf("offset nv.val          %2zu\n", offsetof(&n, nv.val));
  printf("\n");
  printf("sizeof na_e            %2zu\n", sizeof(n.na_e));
  printf("offset na_e.parent     %2zu\n", offsetof(&n, na_e.parent));
  printf("offset na_e.root       %2zu\n", offsetof(&n, na_e.root));
  printf("offset na_e.type       %2zu\n", offsetof(&n, na_e.type));
  printf("offset na_e.name_len   %2zu\n", offsetof(&n, na_e.name_len));
  printf("offset na_e.name       %2zu\n", offsetof(&n, na_e.name));
  printf("sizeof na_e.name       %2zu\n", sizeof(n.na_e.name));
  printf("offset na_e.val        %2zu\n", offsetof(&n, na_e.val));
  printf("\n");
  printf("sizeof na              %2zu\n", sizeof(n.na));
  printf("offset na.parent       %2zu\n", offsetof(&n, na.parent));
  printf("offset na.root         %2zu\n", offsetof(&n, na.root));
  printf("offset na.type         %2zu\n", offsetof(&n, na.type));
  printf("offset na.name_len     %2zu\n", offsetof(&n, na.name_len));
  printf("offset na.name         %2zu\n", offsetof(&n, na.name));
  printf("offset na.val          %2zu\n", offsetof(&n, na.val));
  return 0;
}
